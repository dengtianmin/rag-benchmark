...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Traditional RAG baseline.")
    parser.add_argument(
        "--dataset",
        type=Path,
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("outputs/experiments/traditional_rag"),
...
def main() -> None:
    ...
    records = [pipeline.run(sample) for sample in tqdm(samples, desc="Traditional RAG")]
    metrics = {
